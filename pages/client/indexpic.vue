			...
			<view class="mt24 mb20">
				<view class="flex alcenter space">
					<view class="flex alcenter">
						...
						<text class="ft16 ftw600 cl-main ml15">热门壁纸</text>
					</view>
					<navigator url="/pages/client/tuan/sstp?selectIndex=4">
					<view class="ft14 cl-notice">更多</view>
					</navigator>
				</view>
				<sub-tabvsw class="pt5" v-if="type4tab[1]" :tabs="type4tab" @change="changetype4" :selectIndex="selecttype4" :scrollTop="scrollTop"></sub-tabvsw>
				<view class="mt10 flex space" style="display:flex; flex-wrap:wrap;">
