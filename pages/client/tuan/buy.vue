	...
	<view class="pd16_15">	
			...
			<view class="tuan-buy-r pl15">
				...
				<view v-else class="mt12 alcenter">
					<view>
						...
						<text class="ft16 cl-orange ftw600">¥{{buydata.vippriceq}}</text>
					</view>
					<view>
						<text class="ft14 cl-notice">全集普通价：</text>
						<text class="ft14 cl-notice text-line">¥{{buydata.priceq}}</text>
					</view>
		...
		<view class="box mt16 pd16_15">
			...
			<view class="flex alcenter space">
				...
				<text class="ft16 cl-main ftw600 cl-orange">¥{{pricebuy}}</text>
			</view>
		</view>
		...
		<view class="form-footer-h">
			<view class="form-footer form-footer-h">
				<view class="form-footer-main pd10_15">
					<button v-if="mid>0" class="btn-big" @click="okTap" :style="getBtnStyle">支付 ¥{{pricebuy}}</button>
					<button v-else class="btn-big" @click="okTap" :style="getBtnStyle">支付 ¥{{pricebuy}}</button>
				</view>
			</view>
		</view>
	</view>
